package com.example.sosmeddicoding.data.remoteMediator
...
import com.example.sosmeddicoding.data.database.RemoteKeys
    ...
    override suspend fun load(
        ...
        try {
            ...
            database.withTransaction {
                ...
                val mappedStories = responseData.listStory.map { listStoryItem ->
                    StoryResponseItem(
                        id = listStoryItem.id,
                ...
                database.storyDao().insertStory(mappedStories)
            }
